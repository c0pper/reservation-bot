...
LOCATION_ERR_API_KEY = "Il servizio di geolocalizzazione non \u00e8 configurato. Contatta l\u2019amministratore."
LOCATION_ERR_NETWORK = "Errore di rete durante la ricerca. Riprova pi\u00f9 tardi."
LOCATION_ERR_NO_RESULTS = "Indirizzo non trovato. Riprova con un indirizzo valido."
LOCATION_ERR_FILTERED = "Indirizzo non trovato in Campania. Inserisci un indirizzo nella regione Campania."
